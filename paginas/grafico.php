...
$conn = new conexao_bd();
$result = $conn->query("SELECT pontuacao, dataEntrada FROM historico_perfil
    WHERE idcodigopessoa = ". $_SESSION['id']. " GROUP BY dataEntrada");
...
<div class="container">
    ...
    $(function () {
          Highcharts.chart('container', {
              ...
              tooltip: {
                  pointFormat: 'Probabilidade do risco <b>{point.y} </b>'
              },
              series: [{
                  name: 'Avaliações',
                  data: data,
